...
// Security Blog
export const pqcPosts = {
  title: 'Post-Quantum Cryptography',
  items: [
    { label: 'Quantum Threat & Standards', link: '/projects/blogs/security/pqc/1-quantum-threat-standards' },
    { label: 'Global Response & Strategy', link: '/projects/blogs/security/pqc/2-global-pqc-response' },
    { label: 'Migration Planning', link: '/projects/blogs/security/pqc/3-migration-planning-framework' },
    { label: 'Discovery Phase & Tools', link: '/projects/blogs/security/pqc/4-discovery-phase-tools' },
  ]
};

export const secArchitecure = {
