...
- **Test Set (e.g., ~15%):** This data is **held back** and used _only once_ at the very end. Its purpose is to provide a final, unbiased assessment of the chosen model's performance on unseen data.
...
3. The predicted values are compared with the **actual label values** of the test data.
...
Learning algorithms can also be categorized based on how they handle the information acquisition and generalization during the training process, i.e _when_ they do the work of building a model:
