...
- In statistics, unsupervised learning is closely related to **density estimation**.

> **Process Flow:** Unlabeled Data → Unsupervised Learning Model → Data Patterns

## Types of Unsupervised Learning

The two major techniques are **Clustering** (grouping similar objects together) and **Association Analysis** (identifying patterns or relationships of attributes).

### A. Clustering

It involves grouping similar objects together.
