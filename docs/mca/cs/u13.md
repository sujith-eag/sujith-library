...
**Social engineering** is the art of manipulating people to reveal confidential information or perform actions that compromise security. It exploits human trust rather than technical vulnerabilities, often by building inappropriate trust relationships with insiders.

- **Human-Based Social Engineering**: Involves direct human interaction, such as impersonating an authority figure, shoulder surfing (observing someone’s screen), or dumpster diving (retrieving sensitive data from the trash).
    
- **Computer-Based Social Engineering**: Uses technology to assist the deception, such as fake phishing emails, malicious pop-up windows, and malware-laden attachments(key-loggers, trogen).
    
- **Phishing and Spoofing**: The most common form of social engineering, where deceptive emails or messages are used to steal sensitive data. **Email spoofing** makes a message appear to come from a trusted source to enhance the deception.
