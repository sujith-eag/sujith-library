...
- **Key Characteristics:**
    ...
    - **Targeted:** APTs are not random. They are aimed at specific, high-value targets like governments, corporations, or critical infrastructure.
        
    - **Persistent:** The goal is to remain undetected within the network for months or even years.
...
- **Common Techniques:**
    ...
    - **Initial Access:** Often gained through social engineering, such as highly convincing **phishing** emails.
        
    - **Exploitation:** Use of **zero-day exploits** (vulnerabilities unknown to the software vendor).
        
    - **Lateral Movement:** Once inside, attackers move across the network to gain access to more systems and data.
