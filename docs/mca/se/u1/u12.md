...
- **Early in the process (Inner Rings):** Most effort is spent on understanding **high-level business** and **non-functional requirements**, and abstract user requirements for the system.
    
- **Later in the process (Outer Rings):** More effort is dedicated to eliciting and understanding detailed system requirements and non-functional requirements.
