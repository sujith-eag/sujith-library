...
```mermaid
graph TD    
    classDef technique fill:#e6f7ff,stroke:#91d5ff,stroke-width:2px;
    classDef detail fill:#fafafa,stroke:#d9d9d9,stroke-width:1px;
...
```mermaid
graph TD
    classDef process fill:#e6f7ff,stroke:#91d5ff,stroke-width:2px;
    classDef decision fill:#fffbe6,stroke:#ffe58f,stroke-width:2px;
    classDef outcomeSuccess fill:#d4edda,stroke:#155724,stroke-width:2px;
    classDef outcomeFailure fill:#f8d7da,stroke:#721c24,stroke-width:2px;
